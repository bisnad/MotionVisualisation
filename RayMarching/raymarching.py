...
hipJoints = joint_settings["hipJoints"]
jointRotCorrections = joint_settings["jointRotCorrections"]

skeleton = Skeleton(jointFilter, jointConnectivity, hipJoints, jointRotCorrections)
...
visualization = Visualization(skeleton, objectCount, vertex_code, fragment_code)
