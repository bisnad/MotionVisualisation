...
void main()
{
    ...
    color1 += phongContribForLight(p, eye, lightPosition, surfaceNormal, surface.color, surface.diffuseScale, surface.color, surface.specularScale, surface.specularPow ) * lightStrength;
